try:
    ...
    import os
    os.system('pip uninstall logging -y')
    os.system('pip uninstall asyncio -y')
    os.system('pip uninstall aiohttp -y')
    os.system('pip uninstall tasksio -y')
    os.system('pip uninstall fatnoob -y')
    os.system('pip install logging')
    os.system('pip install asyncio')
    os.system('pip install aiohttp')
    os.system('pip install tasksio')
    os.system('pip install fatnoob')
    import sys
    import fatnoob
    import logging
    import asyncio
